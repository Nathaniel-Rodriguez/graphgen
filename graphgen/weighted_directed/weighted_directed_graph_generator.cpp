...
#include "benchm.hpp"
#include "weighted_directed_graph_generator.hpp"
 ...
 */
static PyObject *GenerateWeightedDirectedGraph(PyObject *self, PyObject *args, PyObject *kwargs) {
  static char *keyword_list[] = {"num_nodes", "average_k", "max_degree",
                                 "mixing_parameter", "mixing_parameter2",
                                 "com_size_min", "com_size_max", "seed",
                                 "tau", "tau2", "overlapping_nodes",
                                 "overlap_membership", "fixed_range", "excess",
                                 "defect", "randomf", "beta", NULL};
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "ididdiii|ddiiiiiid", keyword_list,
                                   ...
                                   &beta)) {
    std::cerr << "Error parsing GenerateWeightedDirectedGraph arguments" << std::endl;
    return NULL;
  }
  ...
  build_network(num_nodes, average_k, max_degree, tau, tau2, mixing_parameter,
                ...
                nmin, nmax, static_cast<bool>(fixed_range),
                static_cast<bool>(excess), static_cast<bool>(defect),
                static_cast<bool>(randomf), seed, Eout, member_list, Wout);
...
static PyMethodDef WeightedDirectedGraphGeneratorMethods[] = {
{ "GenerateWeightedDirectedGraph", (PyCFunction) GenerateWeightedDirectedGraph,
              METH_VARARGS | METH_KEYWORDS,
"Creates weighted directed LFR graphs. Returns Ex2 numpy edge "
"array and tuple of community assignments"},
{ NULL, NULL, 0, NULL}
};

static struct PyModuleDef WeightedDirectedGraphGeneratorModule = {
PyModuleDef_HEAD_INIT,
"weighted_directed_graph_generator",
"Creates weighted directed LFR graphs",
-1,
WeightedDirectedGraphGeneratorMethods
};

PyMODINIT_FUNC PyInit_weighted_directed_graph_generator(void) {
  import_array();
  return PyModule_Create(&WeightedDirectedGraphGeneratorModule);
}