...
def uniform_weighted_directed_lfr_graph(N, mu, k, maxk, minc, maxc, weight_bounds, **kwargs):
    ...
    reservoir = unweighted_directed_lfr_graph(N, mu, k, 
        maxk, minc, maxc, **pardict)
...
if __name__ == '__main__':
    ...
    print(uniform_weighted_directed_lfr_graph_asarray(N=50, mu=0.1, k=4, 
        maxk=4, minc=25, maxc=25, weight_bounds=(0.5, 1.0)))