...
int benchmark(bool excess, bool defect, int num_nodes, double  average_k,
							...
							double  mixing_parameter, int  overlapping_nodes,
							int  overlap_membership, int  nmin, int  nmax, bool  fixed_range,
							double ca, deque<set<int> > &output_Eout,
...
void build_network(int num_nodes, double average_k, int max_degree, double tau,
	...
	benchmark(p.excess, p.defect, p.num_nodes, p.average_k, p.max_degree,
						...
						p.clustering_coeff, output_Eout, output_member_list);
}